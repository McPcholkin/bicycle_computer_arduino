...
// --- set timers without delay start ---
...
unsigned long cadAverage;                      // The RPM value after applying the smoothing.
...
// --- update lcd and serial start ---
  ...
  void update_serial() {
    ...
    Serial.print("\tPeriodAWG: ");
    Serial.print(cadPeriodAverage);
    Serial.print("\tReadings: ");
    Serial.print(cadAmountOfReadings);
    Serial.print("\tFrequency: ");
    Serial.print(cadFrequencyReal);
    Serial.print("\tRPM: ");
    Serial.print(cadRPM);
    Serial.print("\tTachometer: ");
    Serial.println(cadAverage);
  }
#else
  void update_lcd() {
...
void loop() {
  ...
  cadAverage = cadTotal / cadNumReadings;  // The average value it's the smoothed result
  // --- RPM end ---
